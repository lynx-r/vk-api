...
export declare enum EPolitical {
    Communist = 1,
    Socialist = 2,
    Moderate = 3,
    Liberal = 4,
...
export declare enum EPeopleMain {
    SmartAndCreative = 1,
...
export declare enum ERelationsStatus {
    Unknown = 0,
    NotMarried = 1,
    HasFriend = 2,
    Betrothed = 3,
...
export declare enum ESchoolType {
    School = 0,
    Gymnasium = 1,
    Lyceum = 2,
    BoardingSchool = 3,
...
declare type TOnline = {
    online: TPseudoBoolean;
} & ({} | {
    onlineMobile: 1;
    onlineApp: number;
});
declare type TSocial = 'skype' | 'facebook' | 'twitter' | 'livejournal' | 'instagram';
/**
