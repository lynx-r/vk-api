...
export declare type TDeleteFromLastShortenedResult = 1;
/**
...
export declare type TGetLastShortenedLinksResult = IPager<{
    timestamp: number;
    url: string;
    shortUrl: string;
    key: string;
...
export declare type TGetServerTimeResult = number;
/**
