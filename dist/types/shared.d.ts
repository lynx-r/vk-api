 ...
 */
export declare type TLang = 'ru' | 'uk' | 'be' | 'en' | 'es' | 'fi' | 'de' | 'it' | ELang;
/**
 * Pseudo boolean type. Means boolean converted to number.
 */
export declare type TPseudoBoolean = 0 | 1;
/**
 * All boolean types which could be accepted by lib.
 */
export declare type TBoolean = boolean | TPseudoBoolean;
/**
 ...
 */
export declare type TSendRequest = <P extends {} = any, R = any>(config: IRequestConfig<P>) => Promise<R>;
/**
 * Adds new repository to IVKAPI instance.
 */
export declare type TAddRepository<Instance> = <N extends string, R extends Repository>(name: N extends keyof Instance ? never : N, Repo: {
 ...
 */
export declare type TRepositoryMethod<P extends {} = any, R = any> = (params: P & IRequestOptionalParams) => Promise<R>;
/**
