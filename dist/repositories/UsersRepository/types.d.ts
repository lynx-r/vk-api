import { TBoolean, IPager, ERelationsStatus, ESex, TUser, TUserField, TNameCase } from '../../types';
/**
...
export declare type TGetResult = TUser[];
/**
...
export declare type TGetFollowersResult = IPager<TUser>;
/**
...
export declare type TGetSubscriptionsResult = IPager<TUser>;
/**
...
export declare type TReportResult = 1;
/**
...
export declare type TSearchResult = IPager<TUser & {
    trackCode?: string;
}>;
